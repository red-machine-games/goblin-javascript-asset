...
class GbaseAccounts {
    ...
    signupGbaseAnon(callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doSendRequest(URIS['accounts.getAccount'], {}, callbackFn);
        });
    }
    ...
    authWebVk(vkId, vkSecret, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._authInProgressOrDone = true;
            this._gbaseApi._networkManager.doSendRequest(`${URIS['accounts.getAccount']}?vkid=${vkId}&vksecret=${vkSecret}`, {}, callbackFn);
        });
    }
    ...
    authVkSdk(tokenFromVk, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._authInProgressOrDone = true;
            this._gbaseApi._networkManager.doSendRequest(`${URIS['accounts.getAccount']}?vktoken=${tokenFromVk}`, {}, callbackFn);
        });
    }
    ...
    authOkSdk(tokenFromOk, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._authInProgressOrDone = true;
            this._gbaseApi._networkManager.doSendRequest(`${URIS['accounts.getAccount']}?oktoken=${tokenFromOk}`, {}, callbackFn);
        });
    }
    ...
    authFb(tokenFromFb, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._authInProgressOrDone = true;
            this._gbaseApi._networkManager.doSendRequest(`${URIS['accounts.getAccount']}?fbtoken=${tokenFromFb}`, {}, callbackFn);
        });
    }
    ...
    unlinkSocialProfile(callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doSendRequest(URIS['accounts.unlinkSocialProfile'], null, callbackFn);
        });
    }
    ...
    hasVkProfile(tokenFromVk, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doSendRequest(`${URIS['accounts.hasVkProf']}?vktoken=${tokenFromVk}`, null, callbackFn);
        });
    }
    ...
    hasOkProfile(tokenFromOk, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doSendRequest(`${URIS['accounts.hasOkProf']}?oktoken=${tokenFromOk}`, null, callbackFn);
        });
    }
    ...
    hasFbProfile(tokenFromFb, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doSendRequest(`${URIS['accounts.hasFbProf']}?fbtoken=${tokenFromFb}`, null, callbackFn);
        });
    }
}
