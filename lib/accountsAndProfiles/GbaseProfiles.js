            ...
            let callbackFn = err => {
                if(err){
                    ...
                    if(toUpdate.profileData){
                        if(!this._gbaseApi.currentProfile.profileData){
                            this._gbaseApi.currentProfile.profileData = {};
                        }
                    ...
                    if(toUpdate.publicProfileData){
                        if(!this._gbaseApi.currentProfile.publicProfileData){
                            this._gbaseApi.currentProfile.publicProfileData = {};
                        }
