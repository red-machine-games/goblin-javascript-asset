...
class GbaseTickets {
    ...
    listSendedTickets(skip=0, limit=20, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.listSendedTickets']}?skip=${skip}&limit=${limit}`, null, callbackFn);
        });
    }
    ...
    listReceivedTickets(skip=0, limit=20, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.listReceivedTickets']}?skip=${skip}&limit=${limit}`, null, callbackFn);
        });
    }
    ...
    confirmTicket(ticketId, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.confirmTicket']}?ticketId=${ticketId}`, null, callbackFn);
        });
    }
    ...
    confirmTicketVk(ticketId, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.confirmTicketVk']}?ticketId=${ticketId}`, null, callbackFn);
        });
    }
    ...
    confirmTicketOk(ticketId, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.confirmTicketOk']}?ticketId=${ticketId}`, null, callbackFn);
        });
    }
    ...
    confirmTicketFb(ticketId, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.confirmTicketFb']}?ticketId=${ticketId}`, null, callbackFn);
        });
    }
    ...
    rejectTicket(ticketId, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.rejectTicket']}?ticketId=${ticketId}`, null, callbackFn);
        });
    }
    ...
    rejectTicketVk(ticketId, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.rejectTicketVk']}?ticketId=${ticketId}`, null, callbackFn);
        });
    }
    ...
    rejectTicketOk(ticketId, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.rejectTicketOk']}?ticketId=${ticketId}`, null, callbackFn);
        });
    }
    ...
    rejectTicketFb(ticketId, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.rejectTicketFb']}?ticketId=${ticketId}`, null, callbackFn);
        });
    }
    ...
    dischargeTicket(ticketId, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.dischargeTicket']}?ticketId=${ticketId}`, null, callbackFn);
        });
    }
    ...
    dismissTicket(ticketId, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.dismissTicket']}?ticketId=${ticketId}`, null, callbackFn);
        });
    }
    ...
    releaseTicket(ticketId, callback=NOOP){
        return someUtils.promisify(callback, callback => {
            ...
            this._gbaseApi._networkManager.doTheRequest(`${URIS['tickets.releaseTicket']}?ticketId=${ticketId}`, null, callbackFn);
        });
    }
}
